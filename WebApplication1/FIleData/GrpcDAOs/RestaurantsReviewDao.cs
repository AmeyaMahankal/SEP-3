...
public class RestaurantsReviewDao: IRestaurantsReviewDao
{
    ...
    public Task<Review?> GetByIdAsync(int dtoReviewId)
    {
        ...
        var send = client.GetRestaurantsReviewByIdAsync(request);
    ...
    public Task<IEnumerable<Review>> GetAsync(SearchReviewParameterDto searchReviewParameterDto)
    {
        ...
        var send = client.GetRestaurantsReviewsContainingAsync(search);
    ...
    public Task UpdateReviewCommentAsync(Review updated)
    {
        ...
        var send = client.UpdateRestaurantsReviewCommentAsync(request);
    ...
    public Task UpdateReviewStarReviewAsync(Review updated)
    {
        ...
        var send = client.UpdateRestaurantsStarReviewAsync(request);
    ...
    public Task DeleteAsync(int id)
    {
        ...
        var send = client.DeleteRestaurantsReviewAsync(request);
